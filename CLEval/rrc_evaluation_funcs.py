...
from CLEval.file_utils import decode_utf8
from CLEval.box_types import Box, QUAD, POLY

from CLEval.arg_parser import PARAMS
...
def main_evaluation(validate_data_fn, evaluate_method_fn, gt_path, show_result=True, per_sample=True):
    """
    ...
    # print(PARAMS.GT_PATH)
    # print(PARAMS.SUBMIT_PATH)
    # print(PARAMS.OUTPUT_PATH)
    # print(PARAMS.PORT)
    # print(PARAMS.BOX_TYPE)
    # print(PARAMS.TRANSCRIPTION)
    # print(PARAMS.CONFIDENCES)
    # print(PARAMS.CRLF)
    # print(PARAMS.E2E)
    # print(PARAMS.CASE_SENSITIVE)
    # print(PARAMS.RS)
    # print(PARAMS.AREA_PRECISION_CONSTRAINT)
    # print(PARAMS.GRANULARITY_PENALTY_WEIGHT)
    # print(PARAMS.VERTICAL_ASPECT_RATIO_THRES)
    # print(PARAMS.NUM_WORKERS)
    # print(PARAMS.GT_SAMPLE_NAME_2_ID)
    # print(PARAMS.DET_SAMPLE_NAME_2_ID)
    # print(PARAMS.PER_SAMPLE_RESULTS)
    # exit(1)
    # validate_data_fn(PARAMS.GT_PATH, PARAMS.SUBMIT_PATH)
    # evalData = evaluate_method_fn(PARAMS.GT_PATH, PARAMS.SUBMIT_PATH)
    validate_data_fn(gt_path, PARAMS.SUBMIT_PATH)
    evalData = evaluate_method_fn(gt_path, PARAMS.SUBMIT_PATH)
