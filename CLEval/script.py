...
from CLEval import rrc_evaluation_funcs
import math
...
from CLEval.file_utils import load_zip_file, decode_utf8
from CLEval.validation import validate_data
...
def validate(gt_path):
    return rrc_evaluation_funcs.main_evaluation(validate_data, cleval_evaluation, gt_path)
